...
var SOKOBAN_LEVELS=[
  {width:7,height:7,walls:roomWalls(7,7),targets:[[2,2],[4,2]],boxes:[[2,3],[4,3]],player:[3,5],hints:["先把两只箱子各自向上推一格。"]},
  {width:7,height:7,walls:roomWalls(7,7),targets:[[2,2],[3,2],[4,2]],boxes:[[2,3],[3,3],[4,3]],player:[3,5],hints:["先处理中间，再从两侧绕回去推。"]},
  {width:8,height:8,walls:roomWalls(8,8),targets:[[2,2],[5,2],[3,3]],boxes:[[2,4],[5,4],[3,5]],player:[4,6],hints:["先把最下面的箱子送上去，给自己腾空间。"]},
  {width:8,height:8,walls:roomWalls(8,8),targets:[[2,2],[5,2],[4,4]],boxes:[[2,4],[5,4],[4,5]],player:[4,6],hints:["先把中间箱子推上去，再分别处理两侧。"]},
  {width:8,height:8,walls:roomWalls(8,8).concat([[4,3]]),targets:[[2,2],[5,2],[2,5]],boxes:[[2,4],[5,4],[3,5]],player:[4,6],hints:["中间墙会挡路，先清左边再绕去右边。"]},
  {width:9,height:8,walls:roomWalls(9,8).concat([[4,3],[4,4]]),targets:[[2,2],[6,2],[2,5]],boxes:[[2,4],[6,4],[3,5]],player:[5,6],hints:["中间墙把路线切开，留意左右绕行。"]},
  {width:9,height:9,walls:roomWalls(9,9),targets:[[2,2],[4,2],[6,2]],boxes:[[2,4],[4,4],[6,4]],player:[4,7],hints:["三只箱子都要向上送，但顺序会影响站位。"]},
  {width:9,height:9,walls:roomWalls(9,9).concat([[4,3],[4,4]]),targets:[[2,2],[6,2],[2,6]],boxes:[[2,4],[6,4],[3,6]],player:[5,7],hints:["先处理左上，再绕中线去右边。"]},
  {width:10,height:8,walls:roomWalls(10,8),targets:[[2,2],[5,2],[8,2]],boxes:[[2,4],[5,4],[8,4]],player:[5,6],hints:["三列直推，注意别把自己卡在箱子后面。"]},
  {width:10,height:9,walls:roomWalls(10,9).concat([[5,3],[5,4]]),targets:[[2,2],[7,2],[2,6]],boxes:[[2,4],[7,4],[3,6]],player:[6,7],hints:["先看清中间障碍，再决定先送哪只箱子。"]}
];
